...
public class UtilsTest
{
   ...
   [Fact]
    ...
    [Theory]
    [InlineData("Pa$$w0rd", true)]  // ok (contains uppercase, digit, special character, and is of adequate length)
    [InlineData("A1#bCde123456", true)]  // ok (contains uppercase, digit, special character, and is longer than needed)
    [InlineData("12345678", false)]  // no uppercase letter, no special character
    [InlineData("abcdefgh", false)]  // no uppercase letter, no digit, no special character
    [InlineData("ABCDEFGH", false)]  // no digit, no special character
    [InlineData("abcDEF@#", false)]  // no digit
    [InlineData("1234@#&*(", false)]  // no uppercase letter
    [InlineData("", false)]  // empty string (too short)
    [InlineData("abc1#A", false)]  // too short
    [InlineData("a1#bCde", false)]  // no special character 
